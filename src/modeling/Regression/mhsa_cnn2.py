...
class MHSA_CNN(nn.Module):
    def __init__(self, len: int):
        ...
        self.ConvLayer = nn.Sequential(
            nn.Conv1d(4, 16, kernel_size=3, padding=2, stride=1, bias=False),
            nn.BatchNorm1d(16),
            nn.ReLU(),
            nn.Dropout(),
            ...
            nn.Conv1d(16, 64, kernel_size=3, padding=2, stride=1, bias=False),
            nn.BatchNorm1d(64),
        )
        ...
        self.predictor = nn.Sequential(
            nn.BatchNorm1d(4352),
            nn.Linear(in_features=4352, out_features=512),
            nn.ReLU(),
            nn.Dropout(),
            nn.BatchNorm1d(512),
    ...
    def forward(self, inputs):
        ...
        inputs_embs = inputs_embs.transpose(1, 2)
