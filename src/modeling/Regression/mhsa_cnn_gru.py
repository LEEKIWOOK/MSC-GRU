...
class MHSA_CNN_GRU(nn.Module):
    def __init__(self, len: int):
        super(MHSA_CNN_GRU, self).__init__()
        ...
        self.predictor = nn.Sequential(
            nn.BatchNorm1d(5940),
            nn.Linear(in_features=5940, out_features=512),
            nn.ReLU(),
            nn.Dropout(),
            nn.BatchNorm1d(512),
    ...
    def forward(self, inputs):
        ...
        output = torch.cat((attn_out, conv_out, gru_out), dim=1)
